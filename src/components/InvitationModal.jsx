            ...
            <div className="w-1/2 hidden lg:inline">
              ...
              <ul className="mb-6 text-white mt-12">
                <li className="mb-4 flex">
                  <CheckArrowIcon />
                  <span>Creative solutions, always.</span>
                </li>
                <li className="mb-4 flex">
                  <CheckArrowIcon />
                ...
                <li className="mb-4 flex">
                  <CheckArrowIcon />
                  <span>Innovative designs, delivered.</span>
                </li>
              </ul>
            </div>
            <div className="w-full lg:w-1/2 flex items-center flex-col justify-center pt-24 sm:pt-0">
              <div className="inline lg:hidden justiy-start items-center grow basis-0 mb-8 pr-6">
                <div className="flex justify-center text-white mr-2 text-8xl">
